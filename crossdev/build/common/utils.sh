...
get_build_env_var_names() {
  ...
  echo "DEBIAN_FRONTEND,LANG,BUILD_DIR,BUILD_TMP_DIR,BUILD_UTILS_PATH,BUILD_CONSTANTS_PATH,CROSSDEV_USER_ID,CROSSDEV_USER_NAME,CROSSDEV_USER_HOME,CROSSDEV_BUILD_CONFIGS,${constants_vars}"
}
...
gitclone() {
  ...
  git clone --depth=1 "$MIRROR_GITHUB/${GIT_REPO#https://}" "$GIT_DIR"
